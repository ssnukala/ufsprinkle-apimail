...
namespace UserFrosting\Sprinkle\ApiMailer\Mail;
...
class ApiMailer
{
    ...
    public function getMailHeader(MailMessage $message)
    {
        $this->createMessage($message);
        $retarr = [$this->phpMailer->]
        return $this->phpMailer->createHeader();
    }
